        ...
        <section class="tm-section-contact">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-xs-center">
                ...
                <p class="tm-section-intro-text">
                    请写下你的建议和想法,我们一定会好好考虑～<br/>
                </p>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <form action="club/submitSuggest" method="post" class="tm-contact-form">

                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-form-group-center">
						<textarea name="suggest" rows="4" class="form-control"
                                  placeholder="我有一个不成熟的小建议" required></textarea>
                    </div>
