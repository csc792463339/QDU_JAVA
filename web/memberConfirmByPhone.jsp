            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10 ">
                <form action="club/confirm" method="post"
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-form-group-center">
                        姓名:<input type="text" id="name" name="member.name" class="form-control"
                    ...
                    <div
                        ...
                        手机:<input type="number" id="phone" name="member.phone"
                                  ...
                                  value=<%=member.getPhone()%> required readonly="readonly"/>
                    </div>

                    <div
                            class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-form-group-center">
                        QQ:<input type="number" id="qq" name="member.qq" class="form-control"
                                  placeholder="QQ" value=<%=member.getQq()%> required/>
                    </div>
