...
<br/>
<div class="tm-wrapper-center">
    <a href="admin/adminSet.jsp"
       class="btn btn-danger  btn-lg col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10"><i class="fa fa-cogs"></i>
        设置(不要乱动)
    </a>
    <br/>
    <a href="admin/someInfo.jsp"
    ...
    <a href="admin/messageAndSuggestion.jsp"
       class="btn btn-primary  btn-lg col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10"><i class="fa fa-comments"></i>
        建议箱|留言板
    </a>
    <br/>
    <a href="admin/someLink.jsp"
       class="btn btn-success  btn-lg col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10"><i
            class="fa fa-link"></i>
        页面链接 </a>
    <br/>
